...
if (!isset($_SESSION['id_siswa']) && isset($_COOKIE['nis']) && isset($_COOKIE['nama_siswa']) && isset($_GET['auto'])) {
    ...
    $error_msg = "NIS atau nama siswa tidak cocok!";
}
    ...
    if (!preg_match('/^\d{1,11}$/', $nis)) {
        ...
        if ($check_result->num_rows > 0) {
            ...
            if (strtolower($row['nama_siswa']) === strtolower($nama_siswa)) {
                ...
                $error_msg = "Nama tidak cocok dengan NIS!";
            }
        } else {
            $error_msg = "NIS tidak ditemukan!";
        }
    }
}
...
<body>
    ...
    <h1><i class="fa-solid fa-user"></i> Login Siswa</h1>
    ...
    <form method="post" action="">
        <table>
            ...
            <tr>
                <td><input type="text" id="nis" name="nis" placeholder="Masukkan NIS kamu" autocomplete="off" value="<?php echo htmlspecialchars($saved_nis); ?>" required></td>
            </tr>
            <tr>
                <td><label for="nama_siswa">Nama:</label></td>
            </tr>
            <tr>
                <td><input type="text" id="nama_siswa" name="nama_siswa" placeholder="Masukkan nama kamu" autocomplete="off" value="<?php echo htmlspecialchars($saved_nama); ?>" required></td>
            </tr>
            <tr>
