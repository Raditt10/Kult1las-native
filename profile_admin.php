 ...
 <div class="burger" onclick="toggleSidebar()">
    ...
    <div class="profile-card">
        ...
        <table class="profile-table">
            <tr>
                <td class="label">ID Admin</td>
                <td class="value"><?= htmlspecialchars($pengguna['id_pengguna']); ?></td>
            </tr>
            <tr>
                <td class="label">Nama Lengkap</td>
                <td class="value"><?= htmlspecialchars($pengguna['nama_lengkap']); ?></td>
            </tr>
            <tr>
                <td class="label">Username</td>
                <td class="value"><?= htmlspecialchars($pengguna['username']); ?></td>
            </tr>
            <tr>
                <td class="label">Role Anda </td>
                <td class="value"><?= htmlspecialchars(ucfirst($pengguna['role'])); ?></td>
            </tr>
        </table>
     <a href="edit_profilea.php?id=<?= $pengguna['id_pengguna']; ?>" class="btn-edit">
