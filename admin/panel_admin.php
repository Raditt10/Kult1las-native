...
<head>
    ...
    .notif-success button {
      ...
      user-select: none;
        ...
        .card td .badge.badge-success {
            background: #43e97b;
            color: #fff;
        }
        .card td .badge.badge-warning {
            background: #ffe066;
            color: #222;
        }
        .card td .badge.badge-danger {
            background: #e74c3c;
            color: #fff;
        }
        ...
        .wave-hand {
            display: inline-block;
            animation: waveHand 1.6s infinite linear;
...
<?php elseif ($role === 'pembina'): ?>
    <!-- SIDEBAR UNTUK PEMBINA -->
    <h1>Halaman Pembina</h1>
    <div class="burger" onclick="toggleSidebar()">
        <i class="fa-solid fa-bars"></i>
    </div>
    <nav class="sidebar" id="sidebar">
...
<?php endif; ?>
    ...
    <div class="card">
         <h3><span class="wave-hand"><i class="fa-solid fa-hand-wave"></i></span> <i class="fa-solid fa-user"></i> Hai, <?php echo htmlspecialchars($username); ?>! anda login sebagai <?php echo htmlspecialchars($role); ?></h3>
         <p>
            <?php
            ...
            echo $greeting;
            ?>, Silakan kelola data ekstrakurikuler, siswa, admin, prestasi siswa,dan presensi dengan mudah!
        </p>
    </div>
    <div class="card">
    <h3>Statistik</h3>
    <table>
        <tr> 
            <th><i class="fa-solid fa-users"></i> Total Siswa</th> 
            <th><i class="fa-solid fa-list"></i> Total Ekstrakurikuler</th> 
            <th><i class="fa-solid fa-user-plus"></i> Pendaftaran Baru</th> 
        </tr>
        <tr>
    ...
    <div class="card">
    <h3><i class="fa-solid fa-clock-rotate-left"></i> Pendaftaran Terbaru</h3>
    <table>
        <tr> 
            <th><i class="fa-solid fa-hashtag"></i> No</th> 
            <th><i class="fa-solid fa-user"></i> Nama Siswa</th> 
            <th><i class="fa-solid fa-users"></i> Ekstrakurikuler</th> 
    ...
    <div class="card">
    <h3><i class="fa-solid fa-list-check"></i> Daftar Presensi Siswa Terbaru</h3>
    <table>
        <tr>
            <th><i class="fa-solid fa-hashtag"></i> No</th>
            <th><i class="fa-solid fa-user"></i> Nama Siswa</th>
            <th><i class="fa-solid fa-users"></i> Ekstrakurikuler</th>
            <th><i class="fa-solid fa-calendar-days"></i> Tanggal</th>
            <th><i class="fa-solid fa-user-check"></i> Status Kehadiran</th>
            <th><i class="fa-solid fa-check"></i> Status</th>
            <th><i class="fa-solid fa-note-sticky"></i> Catatan</th>
        </tr>
        <?php
        $no = 1;
